...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2025 at 08:09 AM
...
DROP TABLE IF EXISTS `cpri_tests`;
...
DROP TABLE IF EXISTS `cpri_test_results`;
...
--
DROP VIEW IF EXISTS `passed_products`;
...
(31, 'FMF9323477', 'Fuse model F2', 19, '93', '23477', '2025-07-05', '2025-07-05 05:52:17', 'umer', 'Pending'),
(32, 'BLB3208245', 'Bulb', 20, '32', '08245', '2025-07-05', '2025-07-05 05:59:38', 'umer', 'Pending');

--
-- Triggers `products`
--
DROP TRIGGER IF EXISTS `before_insert_product_id`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `generate_product_id`;
DELIMITER $$
...
DROP TABLE IF EXISTS `remanufacturing`;
...
DROP TABLE IF EXISTS `retested_products`;
...
(3, 'FMF2498725', 'FMF2-XX-0001', 'Capacity Test', 'just testing database.', 'just a test file.', 'umer', 'Passed', 'ony for test.', '2025-07-02 01:19:48');
...
-- Triggers `tests`
--
DROP TRIGGER IF EXISTS `after_test_fail`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `after_test_insert_send_to_cpri`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `before_insert_test_id`;
DELIMITER $$
